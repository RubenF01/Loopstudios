...
const classes = ClassGroup({
	navContainer: {
		layout: 'flex justify-between w-full absolute pt-16 px-36',    
 },
 ...
 navElement: {
  ...
  content: "hover:after:content-[''] hover:after:bg-white hover:after:h-px hover:after:w-6 hover:after:absolute hover:after:bottom-0"
 }
});